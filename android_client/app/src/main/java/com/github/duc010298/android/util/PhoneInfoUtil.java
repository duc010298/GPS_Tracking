...
import com.github.duc010298.android.entity.PhoneInfo;

import static android.content.Context.MODE_PRIVATE;

public class PhoneInfoUtil {

    public PhoneInfo getInfoForRegister(Context mContext) {
        ...
        SharedPreferences pre = mContext.getSharedPreferences("IMEI_device", MODE_PRIVATE);
    ...
    public PhoneInfo getInfoForUpdate(Context mContext) {
        SharedPreferences pre = mContext.getSharedPreferences("IMEI_device", MODE_PRIVATE);
        String imei = pre.getString("imei", "");
        ...
        Intent batteryStatus = mContext.getApplicationContext().registerReceiver(null, new IntentFilter(Intent.ACTION_BATTERY_CHANGED));
